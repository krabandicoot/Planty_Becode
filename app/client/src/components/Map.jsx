        ...
        contributors'
            ...
            <MarkerClusterGroup>
                {trees.map((tree, index) => {
                    return (
                        <Marker
                            position={{ lat: tree.lat, lon: tree.lon }}
                            key={index}
                            icon={iconTree}
                        >
                            <Popup>
                                <div>
                                    <div className="speciesTree flex flex-row justify-center m-2">
                                        <h4 className="text-SmokyBlack capitalize">
                                            {tree.name}
                                        </h4>
                                        <AiOutlineInfoCircle
                                            className="ml-2"
                                        ...
                                        if (tree.value === "locked") {
                                            return (
                                                <div className="cardInfoTree flex justify-around items-center">
                                                    <p className="text-SmokyBlack text-[12px]">
                                                        Owner : {tree.owner}
                                                    </p>
                                                    <AiFillLock />
                                                </div>
                                            ...
                                            tree.value === "unavailable"
                                        ) {
                                            return (
                                                <div className="cardInfoTree">
                                                    <p className="text-SmokyBlack ml-2">
                                                        Owner : {tree.owner}
                                                    </p>
