    ...
    return (
        <section className="ml-8 mr-8">
            <div className="card__container mb-2">
                ...
                <p className="text-sm text-justify overflow-y-auto h-80">
                    ...
                    Navigate through Liege with the map and buy new trees. By clicking on a tree, information appears. If the tree is free, you can buy it directly. The price is equal to the amount of leaves it will make you win every 15 minutes. If the tree already has an owner, you can still buy it but its price will vary from the number of trees you have in the area and those of other players. The more trees you have around, the lower the price. <br></br><br></br>
